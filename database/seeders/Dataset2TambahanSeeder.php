...
class Dataset2TambahanSeeder extends Seeder
{
    public function run(): void
    {
        echo "Dataset2 Tambahan Seeder mulai\n";
        
        // Import CSV tambahan ke tabel dataset2 yang sudah ada
        ...
        if (file_exists($csvPath)) {
            ...
            fclose($csv);
            echo "Dataset2 Tambahan Seeder selesai, total $count baris diimpor ke tabel dataset2\n";
        } else {
            echo "File dataset2_tambahan.csv tidak ditemukan\n";
        }
    }
}