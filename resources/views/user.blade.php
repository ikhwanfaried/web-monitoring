...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>User - Web Monitoring System</title>
        ...
        <!-- Scripts -->
        @vite(['resources/css/app.css', 'resources/js/user.jsx'])
    </head>
    <body class="font-sans antialiased">
        ...
        <script>
            ...
            console.log('User element:', document.getElementById('user-app'));
        </script>
        
        <!-- Error fallback -->
        <script>
            setTimeout(() => {
                const appElement = document.getElementById('user-app');
                if (!appElement || appElement.innerHTML.trim() === '') {
                    console.error('User React app failed to load');
