            ...
            <aside className={`group fixed left-0 top-0 h-screen w-16 hover:w-80 backdrop-blur border-r text-white flex flex-col transition-all duration-300 ease-in-out z-50 ${
                ...
                <div className="p-4 group-hover:p-6">
                    <div className="flex items-center">
                        ...
                        <span className="ml-3 text-xl font-bold text-green-400 opacity-0 group-hover:opacity-100 transition-all duration-300 delay-150 whitespace-nowrap">AIRLOGS</span>
                    </div>
                </div>
                ...
                <div className="px-2 group-hover:px-6 py-2 transition-all duration-300 overflow-hidden">
                    <button
                        ...
                        className="w-full flex items-center justify-center group-hover:justify-start space-x-2 p-2 rounded-lg hover:bg-green-800/50 transition-all duration-300 overflow-hidden"
                ...
                <div className="p-2 group-hover:p-6 border-t border-green-500 transition-all duration-300 overflow-hidden">
                    <div className="mb-2 group-hover:mb-4">
                        <div className="flex flex-col items-center text-center w-full">
                            <p className="font-semibold text-green-100 text-sm truncate opacity-0 group-hover:opacity-100 transition-all duration-300 delay-150">{user?.name}</p>
                            <p className="text-green-400 text-xs truncate opacity-0 group-hover:opacity-100 transition-all duration-300 delay-150">{user?.username} (USER)</p>
                        </div>
                    </div>
                    <button
                        onClick={handleLogout}
                        className="w-full bg-green-500 hover:bg-green-400 px-2 group-hover:px-4 py-2 rounded transition-all duration-300 flex items-center justify-center group-hover:justify-start space-x-2 overflow-hidden"
                        title="Logout"
                    >
